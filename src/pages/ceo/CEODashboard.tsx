...
const realKPI = (c: any) => {
  // KPI показывает текущий результат продаж только по активному контракту.
  // Завершённый/неактивный контракт не означает текущие продажи, поэтому KPI = 0.
...
export function CEODashboard() {
  ...
  return <div className="p-4 md:p-6 space-y-6">
    <div><h1 className="text-2xl md:text-3xl font-bold text-[#000052]">Финансовое ядро</h1><p className="text-sm text-[#000052]/70 mt-1">{t('ui.financialOverview')}</p></div>

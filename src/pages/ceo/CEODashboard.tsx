...
export function CEODashboard() {
  ...
  return <div className="w-full min-w-0 overflow-x-hidden p-4 md:p-6 space-y-6">
    ...
    <div className="bg-white min-w-0 p-4 md:p-6 rounded-xl border border-[#000052]/10">
      <div className="flex items-start gap-2 mb-5"><BarChart3 className="w-5 h-5 text-[#B8860B] shrink-0 mt-0.5" /><div className="min-w-0"><h2 className="text-lg font-bold text-[#000052] flex items-center break-words">{t('ui.agentPlanAchievement')}<InfoTooltip>Фактические продажи агента относительно плана продаж по активным контрактам.</InfoTooltip></h2><p className="text-sm text-[#000052]/60 mt-1 break-words">{t('ui.agentPlanDescription')}</p></div></div>

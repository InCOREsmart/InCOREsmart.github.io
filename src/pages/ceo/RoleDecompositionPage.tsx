  ...
  return (
    <div className="p-4 md:p-8 space-y-6 max-w-7xl mx-auto">
      <div className="flex items-start gap-3">
        ...
        <div><h1 className="text-[26px] md:text-3xl font-bold text-[#000052]">AI-декомпозиция роли</h1><p className="text-sm text-gray-400 mt-1">Разложение роли на проверяемые навыки без вмешательства в финансовую модель InCORE.</p></div>
      </div>

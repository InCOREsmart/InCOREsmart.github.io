...
import { getLockedAmount } from '../../lib/annualBonus';

const isActiveContract = (contract: any) => contract.status === 'ACTIVE' || contract.status === 'IN_PROGRESS';

// Показывает именно текущую замороженную сумму, а не первоначальный размер escrow.
// Для завершённого контракта все выплаты уже проведены, поэтому locked = 0.

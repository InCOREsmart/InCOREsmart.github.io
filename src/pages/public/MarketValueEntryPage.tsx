  ...
  return <div className="min-h-screen bg-[#F4F5F7] flex items-center justify-center px-4 py-8">
    <div className="w-full max-w-md bg-white rounded-[24px] shadow-[0_8px_32px_rgba(0,0,52,0.08)] p-8 border border-gray-100">
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <button type="submit" disabled={busy || resending || !name.trim() || !email.trim() || !password || (contactType === 'telegram' ? !telegram.trim() : !phone.trim()) || !consentTos || !consentPrivacy || !consentPd} className="w-full bg-[#000052] text-white py-3.5 rounded-xl font-semibold disabled:opacity-50">{busy ? '...' : c.button}</button>
      </form>

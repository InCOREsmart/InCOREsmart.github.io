...
export function AgentDashboard() {
  ...
  const kpis = [
    { label: 'Всего заработано', value: totalEarned, icon: DollarSign, color: 'bg-[#000052]', textColor: 'text-white' },
    ...
    { label: 'Заморожено в эскроу', value: escrowBalance, icon: Lock, color: 'bg-white', textColor: 'text-[#000052]' },
    { label: 'Удержание (retention)', value: retentionLocked, icon: Shield, color: 'bg-white', textColor: 'text-[#000052]' },
    { label: 'Удержано (clawback)', value: clawedBack, icon: AlertTriangle, color: 'bg-red-600', textColor: 'text-white' },
  ];

  return (
    <div className="p-4 md:p-6 space-y-6">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold text-[#000052]">Моя панель</h1>
      ...
      <div className="bg-gradient-to-r from-[#000052] to-[#B8860B] text-white p-5 rounded-xl">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="font-bold mb-1">Ваши деньги защищены смарт-контрактом</h3>
            <p className="text-sm opacity-90">Выплата происходит только после подтверждения результата. Если клиент уйдёт раньше 90 дней, retention-бонус не выплачивается (clawback).</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-bold text-[#000052]">Мои контракты</h3>
          </div>
          <p className="text-sm text-[#000052]/70">{contracts.length} активных контрактов</p>
        </button>
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-bold text-[#000052]">Выплаты</h3>
          </div>
          <p className="text-sm text-[#000052]/70">Детализация 6 потоков</p>
        </button>
      </div>
    </div>
  );

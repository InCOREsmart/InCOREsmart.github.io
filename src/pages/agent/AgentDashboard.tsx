...
import { DollarSign, TrendingUp, FileText, Target, Briefcase } from 'lucide-react';
        ...
        {activeContracts.length === 0 ? (
          ...
          <div className="space-y-4">
            {activeContracts.map((contract) => {
              ...
              const agentViewEscrow = escrow; // Агент видит эскроу уже за вычетом 12% платформы
                ...
                >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-semibold text-[#000052]">${(gmv - platformFee).toLocaleString()}</p>
                    </div>
                    <div>
                      <p className="text-gray-500">Эскроу (бонусы)</p>
                      <p className="font-semibold text-[#B8860B]">${agentViewEscrow.toLocaleString()}</p>
                    </div>
                    <div>

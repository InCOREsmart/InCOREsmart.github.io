...
export function CreateContractModal({ isOpen, onClose, onCreated }: CreateContractModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!title.trim()) {
      alert('Заполните название контракта');
      return;
    }
    if (!description.trim()) {
      alert('Заполните описание контракта');
      return;
    }
    if (!agentId) {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={2}
                placeholder="Описание целей и задач контракта"
                className="w-full px-4 py-2.5 bg-white border border-[#000052]/20 rounded-lg text-[#000052] focus:outline-none focus:ring-2 focus:ring-[#B8860B]/30"
                required
              />
            </div>
          ...
          <div className="bg-[#000052]/5 p-5 rounded-xl border border-[#000052]/10">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                min={1}
                className="w-full px-3 py-2 bg-white border border-[#000052]/20 rounded-lg text-sm text-[#000052] max-w-xs"
                required
              />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-white p-3 rounded-lg border border-[#000052]/10">
                <div className="text-xs text-[#000052]/50 mb-2">Имущество/риски (20%)</div>
                <input
                  type="number"
              ...
              <div className="bg-white p-3 rounded-lg border border-[#000052]/10">
                <div className="text-xs text-[#000052]/50 mb-2">Автопарки КАСКО (15%)</div>
                <input
                  type="number"
                  value={avgCheckCasco}
              ...
              <div className="bg-white p-3 rounded-lg border border-[#000052]/10">
                <div className="text-xs text-[#000052]/50 mb-2">Медицина ДМС (10%)</div>
                <input
                  type="number"
                  value={avgCheckDms}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-[#B8860B]/5 p-5 rounded-xl border border-[#B8860B]/20">
              ...
              <div className="mb-2">
                <label className="block text-xs font-semibold text-[#000052]/70 mb-1">Процент от общей выручки (%)</label>
                <input
                  type="number"
                  value={planBonusPercent}
                  onChange={(e) => setPlanBonusPercent(Number(e.target.value))}
                  min={0}
                  max={100}
                  className="w-full px-3 py-2 bg-white border border-[#000052]/20 rounded-lg text-sm text-[#000052]"
                />
            ...
            <div className="bg-[#000052]/5 p-5 rounded-xl border border-[#000052]/10">
              ...
              <div className="space-y-3">
                <div>
                  <label className="block text-xs font-semibold text-[#000052]/70 mb-1">Удержание 90 дней ($)</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-xs font-semibold text-[#000052]/70 mb-1">Годовой бонус ($) *</label>
                  <input
                    type="number"
                    value={annualBonus}
                    ...
                    required
                  />
                  <p className="text-xs text-[#000052]/50 mt-1">Выплачивается в январе 2027</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-[#000052] to-[#000052]/90 text-white p-6 rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <div className="text-sm font-semibold text-[#B8860B] mb-2">Общая выручка по договорам:</div>
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold">${calculations.bonusRetention.toLocaleString()}</span>
                </div>
              </div>
              <div className="space-y-3 border-l border-white/20 pl-4">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-bold text-[#B8860B]">{calculations.roi}%</span>
                </div>
              </div>
            </div>
          </div>

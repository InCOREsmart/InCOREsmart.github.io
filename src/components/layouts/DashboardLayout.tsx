...
export function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: t('layout.roleDecomposition', 'Декомпозиция ролей'),
      icon: BrainCircuit,
      role: 'ceo',
    },
    {
      path: '/ceo/agents',
      label: t('layout.agents'),
      icon: Users,
      role: 'ceo',
    },
    {
      path: '/ceo/disputes',
      label: t('layout.disputes'),
      icon: Scale,
      role: 'ceo',
    },
    {
    ...
    {
      path: '/agent',
      label: t('layout.myDashboard'),
      icon: BarChart3,
      role: 'agent',
    },
    {
      path: '/agent/contracts',
      label: t('layout.myContracts'),
      icon: FileText,
      role: 'agent',
    },
    {
      path: '/agent/payouts',
      label: t('layout.payouts'),
      icon: DollarSign,
      role: 'agent',
    },
    {
      path: '/agent/settings',
      label: t('layout.myData'),
      icon: Settings,
      role: 'agent',
    },
  ];

  const userRole = location.pathname.startsWith('/agent')
    ? 'agent'
    : 'ceo';
    ...
    <div className="flex h-[100dvh] min-h-0 w-full max-w-full overflow-hidden bg-[#F4F5F7]">
      ...
      <aside
        className={`
          ...
          flex w-[min(21rem,calc(100vw-1rem))] flex-col
          bg-white
          ...
          <div className="shrink-0 border-t border-gray-100 p-3 sm:p-4">
            <div className="mb-3 flex min-w-0 items-center gap-3 px-1 sm:px-2">
              <div
                ...
                "
              >
                <User className="h-5 w-5 text-[#000052]" />
              </div>

              <div className="min-w-0 flex-1">
                <p className="truncate text-sm font-semibold text-[#000052]">
      ...
      >
        ...
        >
          ...
          <div className="flex shrink-0 items-center gap-0.5 sm:gap-1">
            <div className="max-w-[44px] overflow-hidden sm:max-w-none">
              <LanguageSwitcher />
            </div>

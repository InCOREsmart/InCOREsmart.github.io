    ...
    const load = async () => {
      ...
      try {
        ...
        setContractProgress({
          ...
          actualCalls: Number(contractData?.actual_calls || 0),
          targetCalls: Number(contractData?.kpi_calls || 0),
          actualMeetings: Number(contractData?.actual_meetings || 0),
          targetMeetings: Number(contractData?.kpi_meetings || 0),
          actualProposals: Number(contractData?.actual_proposals || 0),

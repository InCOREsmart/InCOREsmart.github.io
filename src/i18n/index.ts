...
const mergeLocale = (base:any, extra:any, ui:any, supplement:any, feature:any, extendedFeature:any, uiPatch:any, demoPatch:any, i18nFix:any, tooltips:any, notifications:any, hhMarket:any, candidates:any) => ({
  ...base, ...extra, ...ui, ...supplement, ...feature, ...extendedFeature, ...uiPatch, ...demoPatch, ...i18nFix, ...candidates,
  ...
  disputes:{...(base.disputes||{}),...(extra.disputes||{}),...(ui.disputes||{}),...(supplement.ui||{}),...(feature.disputes||{}),...(extendedFeature.disputes||{}),...(uiPatch.disputes||{}),...(demoPatch.disputes||{})},
...
const buildLocale=(lang:'ru'|'en'|'kk'|'az',base:any)=>({...mergeLocale(base,coreTranslations[lang],uiTranslations[lang],uiSupplement[lang],featureTranslations[lang],featureTranslationsExtended[lang],featureTranslationsUiPatch[lang],featureTranslationsDemoPatch[lang],featureTranslationsI18nFix[lang],tooltipTranslations[lang],notificationTranslations[lang],hhMarketTranslations[lang].hhMarket,candidateTranslations[lang]),smartContract:smartContractTranslations[lang]});

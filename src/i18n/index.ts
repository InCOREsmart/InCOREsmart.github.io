...
const mergeLocale = (base: any, extra: any, ui: any, supplement: any, feature: any, extendedFeature: any, uiPatch: any, demoPatch: any) => ({
  ...base, ...extra, ...ui, ...supplement, ...feature, ...extendedFeature, ...uiPatch, ...demoPatch,
  ...
  legacyUi: { ...(feature.legacyUi || {}), ...(extendedFeature.legacyUi || {}), ...(uiPatch.legacyUi || {}), ...(demoPatch.legacyUi || {}) },
});

const ruTranslation = mergeLocale(ru, coreTranslations.ru, uiTranslations.ru, uiSupplement.ru, featureTranslations.ru, featureTranslationsExtended.ru, featureTranslationsUiPatch.ru, featureTranslationsDemoPatch.ru);
const enTranslation = mergeLocale(en, coreTranslations.en, uiTranslations.en, uiSupplement.en, featureTranslations.en, featureTranslationsExtended.en, featureTranslationsUiPatch.en, featureTranslationsDemoPatch.en);
const kkTranslation = mergeLocale(kk, coreTranslations.kk, uiTranslations.kk, uiSupplement.kk, featureTranslations.kk, featureTranslationsExtended.kk, featureTranslationsUiPatch.kk, featureTranslationsDemoPatch.kk);
const azTranslation = mergeLocale(az, coreTranslations.az, uiTranslations.az, uiSupplement.az, featureTranslations.az, featureTranslationsExtended.az, featureTranslationsUiPatch.az, featureTranslationsDemoPatch.az);

export const hrCalculatorTranslations = {
  ...
  en: {
    hrCalculator: {
      ...
      loss: { title: 'What creates the workforce gap', subtitle: 'Three CEO-friendly components: hiring cost, time to productivity and output the role did not create.', recruitment: { title: 'Hiring cost', detail: '20,000 RUB per replacement' }, adaptation: { title: 'Time-to-productivity cost', detail: 'Salary paid before the employee reaches full productivity' }, revenue: { title: 'Lost revenue', detail: 'Assumption: 50% productivity during ramp-up' } },
      metrics: { lossPercent: 'Gap / annual payroll', productivityLoss: 'Productive capacity lost', productivityLossDetail: 'total time for replacements to reach output', revenueRisk: 'Revenue at risk', revenueRiskDetail: 'average monthly value', hrCapacity: 'Annual HR capacity', hrCostYearSuffix: 'annual HR cost', adaptationCost: 'Time-to-productivity cost', adaptationDetail: 'cost before full productivity', recruitmentCost: 'Hiring cost', recruitmentDetail: 'HR capacity cost for all replacements during the year', revenueGap: 'Output gap', revenueGapDetail: '32,400,000 RUB at 0% productivity during ramp-up; total loss uses 50% productivity', lossPerDeparture: 'Cost per replacement', hrCost: 'HR cost / year', turnoverCostEmployee: 'Cost of losing one employee' },
  ...
  az: {
    hrCalculator: {
      ...
      loss: { title: 'Kadr boşluğu nədən yaranır', subtitle: 'Üç aydın komponent: işə qəbul, məhsuldarlığa qədər vaxt və rolun yaratmadığı nəticə.', recruitment: { title: 'İşə qəbul dəyəri', detail: 'Bir əvəzləmə üçün 20 000 ₽' }, adaptation: { title: 'Nəticəyə çıxış dəyəri', detail: 'Əməkdaş tam məhsuldar olana qədər əmək haqqı' }, revenue: { title: 'İtirilmiş gəlir', detail: 'Fərziyyə: nəticəyə çıxış dövründə məhsuldarlıq 50%' } },
      metrics: { lossPercent: 'Boşluq / illik əmək haqqı fondu', productivityLoss: 'İtirilmiş məhsuldar güc', productivityLossDetail: 'əvəzləmələrin nəticəyə çıxış üçün ümumi vaxtı', revenueRisk: 'Riskdə olan gəlir', revenueRiskDetail: 'aylıq orta dəyər', hrCapacity: 'İllik HR gücü', hrCostYearSuffix: 'illik HR dəyəri', adaptationCost: 'Nəticəyə çıxış dəyəri', adaptationDetail: 'tam məhsuldarlığa qədər dövrün dəyəri', recruitmentCost: 'İşə qəbul dəyəri', recruitmentDetail: 'bütün əvəzləmələr üçün HR resursunun illik dəyəri', revenueGap: 'Nəticə boşluğu', revenueGapDetail: 'Nəticəyə çıxış dövründə 0% məhsuldarlıqda 32 400 000 ₽; ümumi hesablamada 50% məhsuldarlıq götürülür', lossPerDeparture: 'Bir əvəzləmə dəyəri', hrCost: 'HR dəyəri / il', turnoverCostEmployee: 'Bir əməkdaşın itirilmə dəyəri' },

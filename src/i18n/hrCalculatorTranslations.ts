export const hrCalculatorTranslations = {
  ...
  en: {
    hrCalculator: {
      ...
      loss: { title: 'What creates the workforce gap', subtitle: 'Three CEO-friendly components: hiring cost, time to productivity and output the role did not create.', recruitment: { title: 'Hiring cost', detail: 'per replacement' }, adaptation: { title: 'Time-to-productivity cost', detail: 'Salary paid before the employee reaches full productivity' }, revenue: { title: 'Lost revenue', detail: 'Assumption: 50% productivity during ramp-up' } },
  ...
  kk: {
    hrCalculator: {
      ...
      loss: { title: 'Кадрлық алшақтық неден тұрады', subtitle: 'Үш түсінікті құрам: найм құны, өнімділікке дейінгі уақыт және рөл жасамаған нәтиже.', recruitment: { title: 'Найм құны', detail: 'бір алмастыруға' }, adaptation: { title: 'Нәтижеге шығу құны', detail: 'Қызметкер толық өнімділікке жеткенге дейінгі жалақы' }, revenue: { title: 'Алынбаған түсім', detail: 'Болжам: нәтижеге шығу кезеңінде өнімділік 50%' } },

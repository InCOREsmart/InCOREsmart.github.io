export const hrCalculatorTranslations = {
  ...
  en: {
    hrCalculator: {
      ...
      metrics: { lossPercent: 'Replacement cost / annual salary', productivityShareDetail: 'share of loss from incomplete productivity', productivityLoss: 'Productive capacity lost', productivityLossDetail: 'total time for replacements to reach output', revenueRisk: 'Revenue at risk', revenueRiskDetail: 'average monthly value', hrCapacity: 'Annual HR capacity', hrCostYearSuffix: 'annual HR cost', adaptationCost: 'Time-to-productivity cost', adaptationDetail: 'cost before full productivity', recruitmentCost: 'Hiring cost', recruitmentDetail: 'HR capacity cost for all replacements during the year', revenueGap: 'Theoretical revenue gap', revenueGapDetail: 'theoretical maximum at 0% productivity; total loss uses 50% productivity', lossPerDeparture: 'Cost per replacement', hrCost: 'HR cost / year', turnoverCostEmployee: 'Cost of losing one employee' },
